...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Função de busca - agora inclui o tipo
  ...
  function renderPage() {
    ...
    filteredPosts.slice(start, end).forEach(post => {
      ...
      // Criando o HTML do card com a imagem clicável e tipo
      card.innerHTML = `
        ${post.image ? `
    ...
    // Adicione estilos para a imagem clicável e tipo
    addImageStyles();
    
    renderPagination();
  }

  // Função para adicionar estilos CSS para imagens clicáveis e tipo
